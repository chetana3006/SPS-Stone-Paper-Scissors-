...
const Projects = () => {
  ...
  <div className='flex gap-2'>
    ...
    <div className='w-80 h-screen bglightblue text-center py-5'>
    ...
    <div className='w-full py-10 px-7 h-screen overflow-y-auto'>
        ...
        <div className='Header flex flex-row  h-12 w-full mb-10 justify-between'>
            <div>
              <h2 className='poppins font-medium text-2xl lightgreen'>OnGoinTasks</h2>
            </div>
            
            <div className='green px-4 py-2  rounded-md text-xl'>
