...
export default function newJcb() {
  return (
    <div className='h-full w-full flex bg-gray-200 flex-col px-10 pb-6 pt-2'>
        <div className='bg3 py-2 mb-2 px-5 font-bold text-2xl text-black'>
            JCB
        </div>
        <div className='flex flex-row gap-2 h-full w-full'>
            <div className='bg-white w-2/3 px-3 py-5 flex h-full poppins justify-around pl-10 flex-col font-medium text-xl'>
