...
import LaborGanttChart from './LabourGanttChart'
  ...
  return (
    <div className='text-black py-4 px-5'>
      ...
      <div className='flex flex-row gap-5 h-96  my-5'>
        <div className='w-4/5 bg-gray-100 shadow-md rounded-lg'>
          <WeatherImpactScatterPlot/>
        </div>
        <div className=' w-full bg-gray-100 shadow-md rounded-lg'>
          <HealthWellnessDashboard/>
        </div>

      </div>
      <div className='flex flex-row gap-5 h-96  my-5'>
        <div className='w-3/5 bg-gray-100 shadow-md rounded-lg'>
          <LaborGanttChart/>
        </div>
        <div className=' w-full bg-gray-100 shadow-md rounded-lg'>
          <DualAxisLineChart/>
